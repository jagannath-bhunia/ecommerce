...
<head>
    ...
    <!-- Data Tables -->
    <link rel="stylesheet" href="{{URL::asset('admin/vendor/dataTables/dataTables.bootstrap.min.css') }}">
...
<body class="animsition">
   ...
   <!-- Jquery JS-->
   <script src="{{URL::asset('admin/vendor/jquery-3.2.1.min.js') }}"></script>
    <!-- Bootstrap JS-->
    <script src="{{URL::asset('admin/vendor/bootstrap-4.1/popper.min.js') }}"></script>
    <script src="{{URL::asset('admin/vendor/bootstrap-4.1/bootstrap.min.js') }}"></script>
    <!-- Vendor JS       -->
    <script src="{{URL::asset('admin/vendor/slick/slick.min.js') }}">
    </script>
    <script src="{{URL::asset('admin/vendor/wow/wow.min.js') }}"></script>
    <script src="{{URL::asset('admin/vendor/animsition/animsition.min.js') }}"></script>
    <script src="{{URL::asset('admin/vendor/bootstrap-progressbar/bootstrap-progressbar.min.js') }}">
    </script>
    <script src="{{URL::asset('admin/vendor/counter-up/jquery.waypoints.min.js') }}"></script>
    <script src="{{URL::asset('admin/vendor/counter-up/jquery.counterup.min.js') }}">
    </script>
    <script src="{{URL::asset('admin/vendor/circle-progress/circle-progress.min.js') }}"></script>
    <script src="{{URL::asset('admin/vendor/perfect-scrollbar/perfect-scrollbar.js') }}"></script>
    <script src="{{URL::asset('admin/vendor/chartjs/Chart.bundle.min.js') }}"></script>
    <script src="{{URL::asset('admin/vendor/select2/select2.min.js') }}">
    </script>
    ...
    <script src="{{URL::asset('admin/vendor/dataTables/datatables-init.js"></script>
</body>
